...
<main class="content">
	...
	<i class="align-middle" data-feather="more-horizontal"></i>
					...
					<div class="card-body">
						<div class="media">
							<img src="<?=base_url();?>assets/img/avatar-5.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Kathy Davis">
						...
						<hr />
						<div class="media">
							<img src="<?=base_url();?>assets/img/avatar.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Andrew Jones">
							<div class="media-body">
						...
						<hr />
						<div class="media">
							<img src="<?=base_url();?>assets/img/avatar-4.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Marie Salter">
							<div class="media-body">
